...
class PathConfig(object):
    ...
    def __init__(self, data_root=None):
        ...
        '''
        self.__version = '(%d-%d-%d-%d-%d-%d)(%d-%d-%d-%d-%d-%d)(%d-%d-%d-%d-%d-%d)f2(%d)fnn(%d-%d)v(%s)' \
 ...
 \
                             self.config.filters_num_cix1, \
                             self.config.kernel_size_cix1, \
                             self.config.filters_num_cix2, \
                             self.config.kernel_size_cix2, \
                             self.config.pool_size_cix, \
                             self.config.hidden_neuron_num_cix, \
 \
 ...
 \
        ...
        self.__path_dict['file_sta_train'] = os.path.abspath(os.path.join(self.get('dir_data'), 'sta_train_2.csv'))
        self.__path_dict['file_sta_test'] = os.path.abspath(os.path.join(self.get('dir_data'), 'sta_test_2.csv'))
        ...
        self.__path_dict['dir_cnn'] = os.path.abspath(os.path.join(self.get('dir_mod'), 'cnn2'))
        ...
        self.__path_dict['file_sub'] = os.path.abspath(os.path.join(self.get('dir_sub'), 'sub_2.csv'))
